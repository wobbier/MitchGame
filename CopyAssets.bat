...
robocopy "Assets" "Build\\Debug\\AppX\\Assets" *.* /w:0 /r:1 /v /log:"Build\\Debug\\Assets.log"
robocopy "Assets" "Build\\Debug\\Assets" *.* /w:0 /r:1 /v /log:"Build\\Debug\\Assets.log"
robocopy "Assets" "Build\\Release\\AppX\\Assets" *.* /w:0 /r:1 /v /log:"Build\\Release\\Assets.log"
robocopy "Assets" "Build\\Release\\Assets" *.* /w:0 /r:1 /v /log:"Build\\Release\\Assets.log"

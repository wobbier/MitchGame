...
robocopy "Engine/Assets" "Build\\Release Editor\\Assets" *.* /mir /w:0 /r:1 /v /log:"Build\\Release Editor\\Assets.log"
robocopy "Engine/Assets" "Build\\Debug Editor\\Assets" *.* /mir /w:0 /r:1 /v /log:"Build\\Debug Editor\\Assets.log"
...
robocopy "Assets" "Build\\Debug Editor\\Assets" *.* /w:0 /r:1 /v /E /log:"Build\\Debug Editor\\Assets.log"
robocopy "Assets" "Build\\Release Editor\\Assets" *.* /w:0 /r:1 /v /E /log:"Build\\Release Editor\\Assets.log"
